...
@class ChatSoundViewViewController;
...
@protocol RIOListenerDelegate <NSObject>
...
@property(nonatomic, assign) id<RIOListenerDelegate> listener;
@property(nonatomic, assign) float MIN_FREQ;
@property(nonatomic, assign) float MAX_FREQ;
