...
- (void)startListening:(ViewController*)aListener {
...
- (void)initializeAudioSession {
	...
	[session setCategory:AVAudioSessionCategoryPlayAndRecord withOptions:kAudioSessionProperty_OverrideCategoryDefaultToSpeaker error:&err];
